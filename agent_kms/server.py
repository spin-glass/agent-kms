...
@mcp.tool()
def retrieve_for_planning(query: str, score_threshold: float = 0.93) -> list[dict]:
    ...
    Args:
        ...
        score_threshold: Boosted-cosine floor. 0.93 is the empirical sweet
            spot for ``multilingual-e5-base`` on Japanese-heavy corpora;
            lower (~0.85) to broaden, raise (~0.95) for strict matches.
